# 089 - Visibility Polygon Raycaster

Standalone vanilla JavaScript lab for computational geometry with a deterministic core, Canvas 2D visualization, benchmark mode, PNG export, and JSON evidence.
