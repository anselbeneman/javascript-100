# 088 - Wave Function Tiles

Standalone vanilla JavaScript lab for constraint solving with a deterministic core, Canvas 2D visualization, benchmark mode, PNG export, and JSON evidence.
