# 075 - Genetic Algorithm Evolver

Standalone vanilla JavaScript lab for optimization with a deterministic core, Canvas 2D visualization, benchmark mode, PNG export, and JSON evidence.
