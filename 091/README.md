# 091 - Rope Constraint Solver

Standalone vanilla JavaScript lab for physics simulation with a deterministic core, Canvas 2D visualization, benchmark mode, PNG export, and JSON evidence.
