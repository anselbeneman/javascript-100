# 078 - Mandelbrot Orbit Studio

Standalone vanilla JavaScript lab for fractals with a deterministic core, Canvas 2D visualization, benchmark mode, PNG export, and JSON evidence.
