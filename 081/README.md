# 081 - Hamming Code Corrector

Standalone vanilla JavaScript lab for error correction with a deterministic core, Canvas 2D visualization, benchmark mode, PNG export, and JSON evidence.
