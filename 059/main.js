(function () {
  ...
  document.getElementById('pngButton').addEventListener('click', () => download('edit-distance-matrix.png', canvas.toDataURL('image/png')));
  document.getElementById('jsonButton').addEventListener('click', () => {
    ...
    download('edit-distance-matrix.json', URL.createObjectURL(new Blob([payload], { type: 'application/json' })));
  });
