# 084 - Merkle Tree Integrity Lab

Standalone vanilla JavaScript lab for cryptographic structures with a deterministic core, Canvas 2D visualization, benchmark mode, PNG export, and JSON evidence.
