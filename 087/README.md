# 087 - Count-Min Sketch Lab

Standalone vanilla JavaScript lab for streaming algorithms with a deterministic core, Canvas 2D visualization, benchmark mode, PNG export, and JSON evidence.
