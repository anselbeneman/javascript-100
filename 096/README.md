# 096 - Interval Tree Query Lab

Standalone vanilla JavaScript lab for data structures with a deterministic core, Canvas 2D visualization, benchmark mode, PNG export, and JSON evidence.
