(function () {
  ...
  document.getElementById('pngButton').addEventListener('click', () => download('union-find-network.png', canvas.toDataURL('image/png')));
  document.getElementById('jsonButton').addEventListener('click', () => {
    ...
    download('union-find-network.json', URL.createObjectURL(new Blob([payload], { type: 'application/json' })));
  });
