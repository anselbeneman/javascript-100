(function () {
  ...
  document.getElementById('pngButton').addEventListener('click', () => download('kmp-string-search.png', canvas.toDataURL('image/png')));
  document.getElementById('jsonButton').addEventListener('click', () => {
    ...
    download('kmp-string-search.json', URL.createObjectURL(new Blob([payload], { type: 'application/json' })));
  });
