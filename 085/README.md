# 085 - Radix Sort Pipeline

Standalone vanilla JavaScript lab for sorting algorithms with a deterministic core, Canvas 2D visualization, benchmark mode, PNG export, and JSON evidence.
