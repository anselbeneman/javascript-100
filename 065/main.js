(function () {
  ...
  document.getElementById('pngButton').addEventListener('click', () => download('streaming-heavy-hitters.png', canvas.toDataURL('image/png')));
  document.getElementById('jsonButton').addEventListener('click', () => {
    ...
    download('streaming-heavy-hitters.json', URL.createObjectURL(new Blob([payload], { type: 'application/json' })));
  });
