# 086 - BK-Tree Fuzzy Search

Standalone vanilla JavaScript lab for search structures with a deterministic core, Canvas 2D visualization, benchmark mode, PNG export, and JSON evidence.
