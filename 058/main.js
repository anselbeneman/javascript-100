(function () {
  ...
  document.getElementById('pngButton').addEventListener('click', () => download('segment-tree-range-min.png', canvas.toDataURL('image/png')));
  document.getElementById('jsonButton').addEventListener('click', () => {
    ...
    download('segment-tree-range-min.json', URL.createObjectURL(new Blob([payload], { type: 'application/json' })));
  });
