(function () {
  ...
  document.getElementById('pngButton').addEventListener('click', () => download('markov-text-chain.png', canvas.toDataURL('image/png')));
  document.getElementById('jsonButton').addEventListener('click', () => {
    ...
    download('markov-text-chain.json', URL.createObjectURL(new Blob([payload], { type: 'application/json' })));
  });
