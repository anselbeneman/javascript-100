# 077 - Cubic Spline Interpolator

Standalone vanilla JavaScript lab for numerical methods with a deterministic core, Canvas 2D visualization, benchmark mode, PNG export, and JSON evidence.
