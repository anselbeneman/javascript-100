# 076 - DBSCAN Cluster Explorer

Standalone vanilla JavaScript lab for machine learning with a deterministic core, Canvas 2D visualization, benchmark mode, PNG export, and JSON evidence.
