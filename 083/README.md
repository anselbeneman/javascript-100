# 083 - PID Control Tuner

Standalone vanilla JavaScript lab for simulation with a deterministic core, Canvas 2D visualization, benchmark mode, PNG export, and JSON evidence.
