# 092 - SimHash Duplicate Detector

Standalone vanilla JavaScript lab for similarity search with a deterministic core, Canvas 2D visualization, benchmark mode, PNG export, and JSON evidence.
