# 070 - Bellman-Ford Route Lab

Standalone vanilla JavaScript lab for graph algorithms with a deterministic core, Canvas 2D visualization, benchmark mode, PNG export, and JSON evidence.
