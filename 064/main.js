(function () {
  ...
  document.getElementById('pngButton').addEventListener('click', () => download('online-perceptron.png', canvas.toDataURL('image/png')));
  document.getElementById('jsonButton').addEventListener('click', () => {
    ...
    download('online-perceptron.json', URL.createObjectURL(new Blob([payload], { type: 'application/json' })));
  });
