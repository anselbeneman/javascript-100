(function () {
  ...
  document.getElementById('pngButton').addEventListener('click', () => download('min-heap-priority-queue.png', canvas.toDataURL('image/png')));
  document.getElementById('jsonButton').addEventListener('click', () => {
    ...
    download('min-heap-priority-queue.json', URL.createObjectURL(new Blob([payload], { type: 'application/json' })));
  });
