# 071 - LZW Compression Workbench

Standalone vanilla JavaScript lab for compression with a deterministic core, Canvas 2D visualization, benchmark mode, PNG export, and JSON evidence.
