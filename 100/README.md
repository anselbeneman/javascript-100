# 100 - Ray Marching SDF Studio

Standalone vanilla JavaScript lab for graphics algorithms with a deterministic core, Canvas 2D visualization, benchmark mode, PNG export, and JSON evidence.
