# 095 - Suffix Array Search Lab

Standalone vanilla JavaScript lab for text algorithms with a deterministic core, Canvas 2D visualization, benchmark mode, PNG export, and JSON evidence.
