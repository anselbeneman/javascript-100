# 097 - Cellular Automata Rule Lab

Standalone vanilla JavaScript lab for cellular automata with a deterministic core, Canvas 2D visualization, benchmark mode, PNG export, and JSON evidence.
