# 093 - FFT Convolution Studio

Standalone vanilla JavaScript lab for signal processing with a deterministic core, Canvas 2D visualization, benchmark mode, PNG export, and JSON evidence.
